...
ln -sf ~/.vim/bundle/powerline/fonts/PowerlineSymbols.otf ~/.fonts/
ln -sf ~/.vim/bundle/powerline/fonts/10-powerline-symbols.conf ~/.config/fontconfig/conf.d/
ln -sf ~/.vim/bundle/powerline/fonts/10-powerline-symbols.conf ~/.fonts.conf.d/
